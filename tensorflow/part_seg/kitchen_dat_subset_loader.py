...
dataset_path=os.path.abspath(os.path.join(BASE_DIR, '../../../3d-point-capsule-affordances-DCG/dataset/kitchendataset_with_labels/converted_dataset/'))
...
if __name__ == '__main__':
    d = PartDataset( root='../../../3d-point-capsule-affordances-DCG/dataset/kitchendataset_with_labels/converted_dataset/',classification=True, class_choice='Mug', npoints=2048, split='test')
    ps, cls = d[0]
